function accessKey() {
	...
	if (e.ctrlKey && e.keyCode == 48) {
		// Ctrl+0
		document.location = 'menu_sales.html';
		return false;
	}
	if (e.ctrlKey && e.keyCode == 49) {
		// Ctrl+1
		document.location = 'sales_order_new_form.tcl';
		return false;
	}
	if (e.ctrlKey && e.keyCode == 50) {
		// Ctrl+2
		document.location = 'customer_select.tcl';
		return false;
	}
	if (e.ctrlKey && e.keyCode == 51) {
		// Ctrl+3
		document.location = 'sales_account_select.tcl';
		return false;
	}
	if (e.ctrlKey && e.keyCode == 52) {
		// Crtl+4
		document.location = 'product_select.tcl';
		return false;
	}
	if (e.ctrlKey && e.keyCode == 54) {
		// Ctrl+6
		document.location = 'sales_order_select.tcl';
		return false;
	}
